function Resizer()
{
    ...
    function resizeVisualElements() {
        ...
        document.getElementById('scoreBox').style.paddingLeft = calc.crossMultiply(160)+'px';
        document.getElementById('scoreBox2').style.paddingLeft = calc.crossMultiply(80)+'px';
