function Resizer()
{
    ...
    function resizeVisualElements() {
        ...
        document.getElementById('scoreBox').style.paddingLeft = calc.crossMultiply(95)+'px';
        document.getElementById('scoreBox2').style.paddingLeft = calc.crossMultiply(185)+'px';
        ...
        dificultyBox.style.paddingLeft = calc.crossMultiply(310)+'px';
